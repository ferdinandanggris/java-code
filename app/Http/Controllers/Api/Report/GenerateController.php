...
use App\Helpers\Report\ExportExcelHelper;
...
class GenerateController extends Controller
{
    ...
    {
        $this->exportExcel = new ExportExcelHelper();
    }
    private $dataForPdf = [
    ...
    public function generatePdf(Request $request)
    {
        ...
        // dd($data);
        return Venturo::PdfView(
            $data['type'],
            $data,
            "invoice{$this->dataForPdf['invoice']['kode']}.pdf",
    ...
    public function importExcel()
    {
         ...
         */
        Excel::store(
            new UserRolesExport($this->arrUserForImport),
            'usersRoles.xlsx'
        );
    ...
    public function exportExcel(Request $request)
    {
        ...
        return $this->exportExcel->downloadExcel($data['type'], $data);
    }
    ...
    public function sendMail()
    {
        try {
             ...
             */
            Mail::to('agung@landa.co.id')->queue(
                new TestsMail($this->dataForPdf)
            );
    ...
    public function getCache(Request $request)
    {
        ...
        if (!Cache::get('dataPribadi')) {
            echo 'Data cache belum dibuat, silahkan klik <a href="' .
                route('generateCache') .
                '">di sini</a> untuk membuat cache baru';
            return;
        }
        ...
        echo '<a href="' .
            route('generateCache') .
            '">Tambah Cache Baru </a> | <a href="' .
            route('getCache', ['hapus' => 'ya']) .
            '">Bersihkan Cache</a><br>';
